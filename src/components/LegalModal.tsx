...
export const LegalModal: React.FC<LegalModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3.5 sm:p-4 bg-black/75 backdrop-blur-md overflow-y-auto font-sans">
      <div className="relative w-full max-w-2xl rounded-2xl border border-neutral-800 bg-[#222222] shadow-2xl p-5 sm:p-7 my-6 text-neutral-100 animate-in fade-in zoom-in-95 duration-150 flex flex-col max-h-[88vh]">
        {/* Close Button */}
        <button
          type="button"
          onClick={() => {
          ...
          className="absolute right-3.5 top-3.5 sm:right-5 sm:top-5 rounded-xl p-2 text-neutral-400 hover:bg-neutral-800 hover:text-white transition-colors cursor-pointer z-10"
        ...
        {/* Header & Tabs */}
        <div className="pr-8 pb-4 border-b border-neutral-800 shrink-0 space-y-3">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-neutral-800 text-mint-300 border border-neutral-700 shadow-2xs">
          ...
          {/* Tab Switcher */}
          <div className="flex items-center gap-1.5 rounded-xl bg-[#1e1e1e] p-1 border border-neutral-800">
            <button
              type="button"
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 rounded-lg py-1.5 text-xs font-bold transition-all cursor-pointer ${
                activeTab === 'privacy'
                  ? 'bg-[#2a2a2a] text-white shadow-xs border border-neutral-700'
        ...
        <div className="overflow-y-auto py-4 space-y-6 text-xs text-neutral-300 leading-relaxed pr-1 scrollbar-thin">
          {activeTab === 'privacy' ? (
            /* ── Privacy Policy ── */
            <>
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">1. Overview & Commitment</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">2. Information We Collect</h3>
                <ul className="list-disc pl-4 space-y-1 text-neutral-400">
                  <li>
                    <strong className="text-white font-semibold">Account Information:</strong> When you sign in via Google OAuth, we receive your basic public profile (name, email address, and avatar image) to authenticate product ownership and creator profiles.
                  </li>
                  <li>
                    <strong className="text-white font-semibold">Product Submissions:</strong> Website URLs, product names, categories, descriptions, logos/favicons, and social handles that you publicly submit to our directory.
                  </li>
                  <li>
                    <strong className="text-white font-semibold">Game & Scoring Data:</strong> Game duration, velocity, and score progression earned in the TopSAAS Runner, verified via anti-cheat mechanics to prevent scripting.
                  </li>
                  <li>
                    <strong className="text-white font-semibold">Payment Details:</strong> When claiming a Featured Spot, payments are processed directly by our secure payment provider (Dodo Payments / Stripe). We never collect or store full credit card numbers on our servers.
                  </li>
                  <li>
                    <strong className="text-white font-semibold">Local Storage & Preferences:</strong> We store local interface preferences such as sound FX toggles, selected view layout (cards vs. table), and submission drafts.
                  </li>
                </ul>
              </section>

              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">3. How We Use Your Information</h3>
                ...
                <p className="font-semibold text-mint-300 pt-1">
                  We will never sell, rent, or trade your personal information to third-party advertisers.
                </p>
              </section>

              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">4. Third-Party Services & Infrastructure</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">5. Data Retention & Deletion Rights</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">6. Updates to This Policy</h3>
                <p>
            ...
            <>
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">1. Acceptance of Terms</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">2. Directory Submissions & Content Guidelines</h3>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">3. Fair Play & Anti-Cheat Policy</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">4. Featured Spots & Commercial Placements</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">5. Intellectual Property</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">6. Disclaimer of Warranties & Limitation of Liability</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className="text-sm font-black text-white">7. Modifications to Service</h3>
                <p>
        ...
        <div className="pt-4 border-t border-neutral-800 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-1.5 text-[11px] text-neutral-400 font-medium">
            <CheckCircle2 className="h-3.5 w-3.5 text-mint-400 shrink-0" />
          ...
          <button
            ...
            className="rounded-xl bg-white px-5 py-2 text-xs font-black text-black shadow-2xs hover:bg-neutral-200 transition-all cursor-pointer"
          >
            Close
          </button>
        </div>
